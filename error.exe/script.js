document.addEventListener('DOMContentLoaded', () => {
            ...
            try {
                ...
                if (success && data) {
                    ...
                    if (data.discord_user.avatar) {
                        ...
                        avatarEl.src = `https://cdn.discordapp.com/avatars/${DISCORD_ID}/${data.discord_user.avatar}.${ext}?size=128`;
                    } else {
                        const defaultAvatar = parseInt(data.discord_user.discriminator) % 5 || 0;
                        avatarEl.src = `https://cdn.discordapp.com/embed/avatars/${defaultAvatar}.png`;
                    }
    ...
    const tracks = ['bg-music.mp3', 'bg-music-2.mp3'];
    ...
    if (musicToggle && bgMusic && musicIcon) {
        ...
        musicToggle.addEventListener('click', () => {
            if (bgMusic.paused) {
                bgMusic.play();
                musicIcon.className = (bgMusic.volume > 0 && bgMusic.volume < 0.5) ? 'fa-solid fa-volume-low' : 'fa-solid fa-volume-high';
            } else {
                bgMusic.pause();
